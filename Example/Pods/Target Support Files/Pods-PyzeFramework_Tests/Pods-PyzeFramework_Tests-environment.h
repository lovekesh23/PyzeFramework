...
// PyzeFramework
#define COCOAPODS_POD_AVAILABLE_PyzeFramework
#define COCOAPODS_VERSION_MAJOR_PyzeFramework 0
#define COCOAPODS_VERSION_MINOR_PyzeFramework 1
#define COCOAPODS_VERSION_PATCH_PyzeFramework 0
